...
const ProductItem = ({price, newPrice, title, desc, discount, isFavorite, isLimited, attachment}) => (
    <Col xs={12} md={6} xl={4} className="product-wrapper my-2">
        ...
        <Button variant="light" className="check-btn d-flex justify-content-center align-items-center"><FiShoppingBag className="mr-1"/>Check Now</Button>
    </Col>
)
